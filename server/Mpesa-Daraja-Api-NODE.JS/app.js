...
async function getAccessToken() {
  const consumer_key = "Vv6XeQzVXWRJW1GtcLs5FutHOS6jBpgtighDQt77R1uCXGZP"; // REPLACE IT WITH YOUR CONSUMER KEY
  const consumer_secret = "AhviUg0klRN0SBdjFsfbyLR1GNAecJQYl861GISnrgq4HgfemJvSJ8Aq1nYTDS6r"; // REPLACE IT WITH YOUR CONSUMER SECRET
  const url =
  ...
  getAccessToken()
    .then((accessToken) => {
      const securityCredential =
        "AhviUg0klRN0SBdjFsfbyLR1GNAecJQYl861GISnrgq4HgfemJvSJ8Aq1nYTDS6r"
      const auth = "Bearer " + accessToken;
      axios
        .post(
          url,
