...
async function getAccessToken() {
  const consumer_key = process.env.SAFARICOM_CONSUMER_SECRET; // REPLACE IT WITH YOUR CONSUMER KEY
  const consumer_secret = process.env.SAFARICOM_CONSUMER_KEY; // REPLACE IT WITH YOUR CONSUMER SECRET
  const url =
